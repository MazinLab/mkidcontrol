...
static const struct usb_device_id id_table[] = {
	...
	{ USB_DEVICE(0x1FB9, 0x0305) }, /* Lake Shore Model 372 AC Bridge */
	...
	{ USB_DEVICE(0x1FB9, 0x0701) }, /* Lake Shore Model 776 Hall Matrix */	{ USB_DEVICE(0x2184, 0x0030) }, /* GW Instek GDM-834x Digital Multimeter */
